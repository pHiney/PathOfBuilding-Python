...
class Ui_BrowseFile(object):
    def setupUi(self, BrowseFile):
        ...
        self.radioBtn_v2 = QRadioButton(BrowseFile)
        self.radioBtn_v2.setObjectName(u"radioBtn_v2")
        self.radioBtn_v2.setMinimumSize(QSize(40, 24))
        self.radioBtn_v2.setChecked(True)

        self.hLayout_SaveAs.addWidget(self.radioBtn_v2)

        self.radioBtn_v1 = QRadioButton(BrowseFile)
        self.radioBtn_v1.setObjectName(u"radioBtn_v1")
        self.radioBtn_v1.setMinimumSize(QSize(40, 24))

        self.hLayout_SaveAs.addWidget(self.radioBtn_v1)
        ...
        self.hSpacer_Buttons = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        QWidget.setTabOrder(self.lineEdit_SaveAs, self.radioBtn_v2)
        QWidget.setTabOrder(self.radioBtn_v2, self.radioBtn_v1)
    ...
    def retranslateUi(self, BrowseFile):
        ...
        self.radioBtn_v2.setText(QCoreApplication.translate("BrowseFile", u"v&2", None))
        self.radioBtn_v1.setText(QCoreApplication.translate("BrowseFile", u"v&1", None))
