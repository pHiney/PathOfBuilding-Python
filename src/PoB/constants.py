...
player_stats_list = {
    ...
    "AverageBurstDamage": {"label": "Average Burst Damage", "condition": "Y", "fmt": "%0.1f"},
    ...
    "Speed": {
        ...
        "trigger": {"label": "Effective Trigger Rate", "fmt": "%0.2f"},
        },
    "WarcryCastTime": {"label": "Cast Time", "fmt": "%0.2fs", "flag": "warcry"},
    "HitSpeed": {"label": "Hit Rate", "condition": "Y", "fmt": "%0.2f"},
    "HitTime": {"label": "Channel Time", "fmt": "%0.2fs", "condition": "Y","flag": "channelRelease"},
    ...
    "TotemPlacementTime": {"label": "Totem Placement Time", "condition": "Y", "fmt": "%0.2fs"},
    "PreEffectiveCritChance": {"label": "Crit Chance", "fmt": "%0.2f%%"},
    "CritChance": {"label": "Effective Crit Chance", "condition": "Y", "fmt": "%0.2f%%"},
    "CritMultiplier": {"label": "Crit Multiplier", "condition": "Y", "fmt": "%d"},
    "HitChance": {
        "condition": "Y",
    ...
    "TotalDPS": {
        "condition": "Y",
        "showAverage": {"label": "Total DPS", "fmt": "%0.1f", "flag": "showAverage"},
    ...
    "WithDotDPS": {"label": "Total DPS inc. DoT", "condition": "Y", "fmt": "%0.1f", "flag": "notAverage"},
    "BleedDPS": {"label": "Bleed DPS", "fmt": "%0.1f"},
    "CorruptingBloodDPS": {"label": "Corrupting Blood DPS", "condition": "Y", "fmt": "%0.1f"},
    "BleedDamage": {"label": "Total Damage per Bleed", "fmt": "%0.1f", "flag": "showAverage"},
    "WithBleedDPS": {"label": "Total DPS inc. Bleed", "condition": "Y", "fmt": "%0.2f"},
    ...
    "MirageBurningGroundDPS": {"label": "Mirage Burning Ground DPS", "condition": "Y", "fmt": "%0.1f"},
    "WithIgniteDPS": {"label": "Total DPS inc. Ignite", "condition": "Y", "fmt": "%0.2f", "flag": "notAverage"},
    ...
    "MirageCausticGroundDPS": {"label": "Mirage Caustic Ground DPS", "fmt": "%0.1f"},
    ...
    "MirageDPS": {"label": "Total Mirage DPS", "fmt": "%0.1f", "flag": "mirageArcher"},
    ...
    "CullingDPS": {"label": "Culling DPS", "condition": "ReservationDPS", "fmt": "%0.1f"},
    "ReservationDPS": {"label": "Reservation DPS", "condition": "ReservationDPS", "fmt": "%0.1f"},
    "CombinedDPS": {"label": "Combined DPS", "condition": "Y", "fmt": "%0.1f"},
    "CombinedAvg": {"label": "Combined Total Damage", "condition": "Y", "fmt": "%0.1f", "flag": "showAverage"},
